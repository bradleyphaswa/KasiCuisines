...
public class Business_postMeal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_post_meal);
        ...
        post_dish = (Button) findViewById(R.id.button_post_meal);
    ...
    private void uploadImage() {
        ...
        if(imageuri != null){
            final ProgressDialog progressDialog = new ProgressDialog(Business_postMeal.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodDetails")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Business_postMeal.this,"Dish Posted Successfully!",Toast.LENGTH_SHORT).show();
                                }
                            });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(Business_postMeal.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
