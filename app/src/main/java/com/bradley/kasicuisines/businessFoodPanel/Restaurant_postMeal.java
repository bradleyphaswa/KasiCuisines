...
public class Restaurant_postMeal extends AppCompatActivity {

    ImageButton imageButton;
    Button post_meal;

    TextInputLayout mealName, desc,qty,pri;
    String descrption,quantity,price, meal;
    Uri imageuri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant_post_meal);
        ...
        post_meal = (Button) findViewById(R.id.button_post_meal);
        ...
        try {
            ...
            dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    post_meal.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            meal = mealName.getEditText().getText().toString().trim();
    ...
    private void uploadImage() {
        ...
        if(imageuri != null){
            final ProgressDialog progressDialog = new ProgressDialog(Restaurant_postMeal.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodDetails")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Restaurant_postMeal.this,"Meal Posted Successfully!",Toast.LENGTH_SHORT).show();
                                }
                            });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(Restaurant_postMeal.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
