...
public class RestaurantPreparedOrderViewAdapter extends RecyclerView.Adapter<RestaurantPreparedOrderViewAdapter.ViewHolder>{

    private Context mContext;
    private List<RestaurantFinalOrders> restaurantFinalOrdersList;

    public RestaurantPreparedOrderViewAdapter(Context mContext, List<RestaurantFinalOrders> restaurantFinalOrdersList) {
    ...
    @NonNull
    @Override
    public RestaurantPreparedOrderViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.restaurant_prepared_order_view, parent, false);
        return new RestaurantPreparedOrderViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RestaurantPreparedOrderViewAdapter.ViewHolder holder, int position) {
