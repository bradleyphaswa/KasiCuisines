...
public class DeliveryVerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneNumber = getIntent().getStringExtra(DeliveryRegistration.PHONE_NUMBER);
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(DeliveryVerifyPhone.this, e.getMessage(),
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            startActivity(new Intent(DeliveryVerifyPhone.this, MainMenu.class));
                            finish();
                        } else {
                            Toast.makeText(DeliveryVerifyPhone.this, task.getException().getMessage(),
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
