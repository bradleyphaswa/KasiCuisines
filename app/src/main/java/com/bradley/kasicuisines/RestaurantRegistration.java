...
public class RestaurantRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new ProgressDialog(RestaurantRegistration.this);
                            ...
                            public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                                ...
                                if(isEmailEmpty) {
                                    ...
                                    if(doStringsMatch(password, confirmPassword)) {
                                        ...
                                        Toast.makeText(RestaurantRegistration.this, "Passwords do not match",
                                                Toast.LENGTH_SHORT).show();
                                    }

                                }
                                else {
                                    Toast.makeText(RestaurantRegistration.this, "Email already registered",
                                            Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    } else {
                        Toast.makeText(RestaurantRegistration.this, "Please enter a valid email address",
                                Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(RestaurantRegistration.this, "Please fill in all the fields",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b_signin_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), RestaurantLoginEmail.class));
                finish();
            }
        });
        ...
        b_signin_phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), RestaurantLoginPhone.class));
                finish();
            }
        });
    ...
    private void registerNewEmail(final String email, final String password) {
        ...
        mFirebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(!task.isSuccessful()) {
                    mDialog.dismiss();
                    Toast.makeText(RestaurantRegistration.this, "Unable to Register",
                            Toast.LENGTH_SHORT).show();
    ...
    private void redirectLoginScreen() {
        startActivity(new Intent(RestaurantRegistration.this, MainMenu.class));
    }
                            ...
                            if (task.isSuccessful()) {
                                ...
                                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        Intent b = new Intent(RestaurantRegistration.this, RestaurantVerifyPhone.class);
                                ...
                                mDialog.dismiss();
                                Toast.makeText(RestaurantRegistration.this, "Couldn't Send Verification Email", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
