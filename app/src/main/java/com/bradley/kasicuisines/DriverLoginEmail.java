...
public class DriverLoginEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_login_email);
    ...
    public boolean servicesOK(){
        ...
        int isAvailable = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(DriverLoginEmail.this);
        ...
        if(isAvailable == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(DriverLoginEmail.this, isAvailable, ERROR_DIALOG_REQUEST);
            dialog.show();
        }
        else{
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if(user.isEmailVerified()){
                        ...
                        Intent intent = new Intent(getApplicationContext(), DriverPanel_BottomNavigation.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();

                    }else{
                        Toast.makeText(DriverLoginEmail.this, "Email is not Verified\nCheck your Inbox", Toast.LENGTH_LONG).show();
