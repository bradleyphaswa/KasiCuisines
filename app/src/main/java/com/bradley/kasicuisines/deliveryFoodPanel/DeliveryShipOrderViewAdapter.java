...
public class DeliveryShipOrderViewAdapter extends RecyclerView.Adapter<DeliveryShipOrderViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mealName.setText(deliveryShipFinalOrders.getMealName());
        holder.price.setText("Price: R " + deliveryShipFinalOrders.getMealPrice());
        holder.quantity.setText("× " + deliveryShipFinalOrders.getMealQuantity());
        holder.totalprice.setText("Total: R " + deliveryShipFinalOrders.getTotalPrice());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            mealName = itemView.findViewById(R.id.dish2);
