...
public class Delivery_ShippingOrder extends AppCompatActivity {
    ...
    TextView Address, RestaurantName, grandtotal, MobileNumber, Custname;
    Button Call, Shipped;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RestaurantName = (TextView) findViewById(R.id.chefname2);
    ...
    private void Shipped() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                grandtotal.setText("R " + deliveryShipFinalOrders1.getGrandTotalPrice());
                Address.setText(deliveryShipFinalOrders1.getAddress());
                Custname.setText(deliveryShipFinalOrders1.getName());
                MobileNumber.setText("+27" + deliveryShipFinalOrders1.getMobileNumber());
                RestaurantName.setText("Restaurant " + deliveryShipFinalOrders1.getRestaurantName());
                userid = deliveryShipFinalOrders1.getUserId();
                Restaurantid = deliveryShipFinalOrders1.getRestaurantId();
                Shipped.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        FirebaseDatabase.getInstance().getReference("CustomerFinalOrders")
                                .child(userid).child(randomuid).child("OtherInformation")
                                .child("Status").setValue("Your Order is delivered")
                            ...
                            public void onSuccess(Void aVoid) {
                                FirebaseDatabase.getInstance().getReference().child("Tokens")
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        sendNotifications(usertoken, "Home Restaurant", "Thank you for Ordering", "ThankYou");
                                    }
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        dialog.dismiss();
                                        Intent intent = new Intent(Delivery_ShippingOrder.this, DeliveryPanel_BottomNavigation.class);
                            ...
                            @Override
                            public void onSuccess(Void aVoid) {
                                FirebaseDatabase.getInstance().getReference("CustomerFinalOrders").child(userid)
                                        .child(randomuid).child("Meals").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        FirebaseDatabase.getInstance().getReference("CustomerFinalOrders")
                                                .child(userid).child(randomuid).child("OtherInformation").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
