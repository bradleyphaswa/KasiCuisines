...
import com.bradley.kasicuisines.PasswordResetDialog;
...
public class DriverPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current = (TextInputLayout) findViewById(R.id.d_current_pwd);
        neww = (TextInputLayout) findViewById(R.id.d_new_pwd);
        confirm = (TextInputLayout) findViewById(R.id.d_confirm_pwd);
        change_pwd = (Button) findViewById(R.id.d_change);
        forgot = (TextView) findViewById(R.id.d_forgot_pwd);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("Drivers")
                                                            .child(userid).child("Password").setValue(ne);
                                                    FirebaseDatabase.getInstance().getReference("Drivers")
                                                            .child(userid).child("ConfirmPassword").setValue(conf);
                ...
                forgot.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent aa=new Intent(DriverPassword.this, PasswordResetDialog.class);
                        startActivity(aa);
                    }
                });
