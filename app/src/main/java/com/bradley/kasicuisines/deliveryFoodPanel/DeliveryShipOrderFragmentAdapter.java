...
public class DeliveryShipOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryShipOrderFragmentAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.delivery_ship_orders, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.grandtotalprice.setText("Grand Total: R " + deliveryShipFinalOrders1.getGrandTotalPrice());
        holder.mobilenumber.setText("+27" + deliveryShipFinalOrders1.getMobileNumber());
        ...
        holder.ShipOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference("CustomerFinalOrders")
                        ...
                        .child("Status").setValue("Your Order is on the way...").addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
