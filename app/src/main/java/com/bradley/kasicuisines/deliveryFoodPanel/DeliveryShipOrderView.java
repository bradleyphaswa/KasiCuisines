...
public class DeliveryShipOrderView extends AppCompatActivity {
    ...
    String RandomUID;
    TextView grandtotal, address, name, number, RestaurantName;
    LinearLayout l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewMeal = findViewById(R.id.delishipvieworder);
        recyclerViewMeal.setHasFixedSize(true);
        recyclerViewMeal.setLayoutManager(new LinearLayoutManager(DeliveryShipOrderView.this));
        l1 = (LinearLayout) findViewById(R.id.linear2);
        grandtotal = (TextView) findViewById(R.id.Shiptotal);
        RestaurantName = (TextView) findViewById(R.id.chefname1);
    ...
    private void deliveryfinalorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipFinalOrders")
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                number.setText("+27" + deliveryShipFinalOrders1.getMobileNumber());
