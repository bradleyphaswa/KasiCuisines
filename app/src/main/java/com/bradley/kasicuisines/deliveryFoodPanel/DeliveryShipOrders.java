...
public class DeliveryShipOrders {
    ...
    public DeliveryShipOrders(String restaurantId, String mealId, String mealName, String mealPrice, String mealQuantity, String randomUID, String totalPrice, String userId) {
