...
public class DeliveryPendingOrderView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewMeal = findViewById(R.id.delivieworder);
        recyclerViewMeal.setHasFixedSize(true);
        recyclerViewMeal.setLayoutManager(new LinearLayoutManager(DeliveryPendingOrderView.this));
        l1 = (LinearLayout) findViewById(R.id.linear1);
        grandtotal = (TextView) findViewById(R.id.Dtotal);
        address = (TextView) findViewById(R.id.DAddress);
        RestaurantName=(TextView)findViewById(R.id.chefname);
    ...
    private void deliveryorders() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                grandtotal.setText("R " + deliveryShipOrders1.getGrandTotalPrice());
                address.setText(deliveryShipOrders1.getAddress());
                name.setText(deliveryShipOrders1.getName());
                number.setText("+27" + deliveryShipOrders1.getMobileNumber());
                RestaurantName.setText("Restaurant "+ deliveryShipOrders1.getRestaurantName());
