...
public class CustomerCartFragment extends Fragment {
    ...
    String mealId, randomUId, restaurantId;
                ...
                if (cartModelList.size() == 0) {
                    ...
                    remove.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setMessage("Are you sure you want to remove Meal");
                            builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {

                                    FirebaseDatabase.getInstance().getReference("Cart")
                                            .child("CartItems").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue();
                                    FirebaseDatabase.getInstance().getReference("Cart")
                                            .child("GrandTotal").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue();
                            ...
                            placeorder.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    FirebaseDatabase.getInstance().getReference("AlreadyOrdered")
                                            ...
                                            .child("isOrdered").addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        ...
                                                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                                                    ...
                                                                    hashMap.put("mealId", cart1.getMealId());
                                                                    hashMap.put("mealName", cart1.getMealName());
                                                                    hashMap.put("mealQuantity", cart1.getMealQuantity());
                                                                ...
                                                                ref = FirebaseDatabase.getInstance().getReference("Cart")
                                                                        .child("GrandTotal").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                                                        .child("GrandTotal");
                                                                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        FirebaseDatabase.getInstance().getReference("CustomerPendingOrders")
                                                                                .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                                                                .child(randomUId).child("OtherInformation").setValue(hashMap1)
                                                                                    ...
                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                                        ...
                                                                                        FirebaseDatabase.getInstance().getReference("Cart").child("CartItems")
                                                                                                ...
                                                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                    ...
                                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                                                        FirebaseDatabase.getInstance().getReference("Cart")
                                                                                                                .child("GrandTotal").child(FirebaseAuth.getInstance().getUid())
                                                                                                                ...
                                                                                                                getRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                    ...
                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                        ...
                                                                                                                        for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                                                                                            ...
                                                                                                                            String d = customerPendingOrders.getMealId();
                                                                                                                            String userid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                                                                                                                            restaurantId = customerPendingOrders.getRestaurantId();
                                                                                                                            final HashMap<String, String> hashMap2 = new HashMap<>();
                                                                                                                            hashMap2.put("restaurantId", restaurantId);
                                                                                                                            hashMap2.put("mealId", customerPendingOrders.getMealId());
                                                                                                                            hashMap2.put("mealName", customerPendingOrders.getMealName());
                                                                                                                            hashMap2.put("mealQuantity", customerPendingOrders.getMealQuantity());
                                                                                                                            hashMap2.put("price", customerPendingOrders.getMealPrice());
                                                                                                                            ...
                                                                                                                            FirebaseDatabase.getInstance().getReference("RestaurantPendingOrders")
                                                                                                                                    .child(restaurantId).child(randomUId).child("Meals").child(d).setValue(hashMap2);
                                                                                                                        }
                                                                                                                        ...
                                                                                                                        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                            ...
                                                                                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference("RestaurantPendingOrders")
                                                                                                                                        .child(restaurantId).child(randomUId).child("OtherInformation").setValue(hashMap3)
                                                                                                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                                                            @Override
                                                                                                                                            public void onSuccess(Void aVoid) {

                                                                                                                                                FirebaseDatabase.getInstance().getReference("AlreadyOrdered")
                                                                                                                                                        .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("isOrdered").setValue("true")
                                                                                                                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                                                                            @Override
                                                                                                                                                            public void onSuccess(Void aVoid) {

                                                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(restaurantId).child("token")
                                                                                                                                                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                                                            ...
                                                                                                                                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                                                                ...
                                                                                                                                                                                ReusableCodeForAll.ShowAlert(getContext(), "", "Your Order has been shifted to Pending state, please wait until the Restaurant accept your order.");
                                                                                                                                                                            }
...
//                                                                }
                                                ...
                                                ReusableCodeForAll.ShowAlert(getContext(), "Error", "It seems like you have already placed an order, So you cannot place another order until the delivery of first order");
                                            }
