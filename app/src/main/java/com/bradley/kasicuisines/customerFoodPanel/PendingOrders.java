...
public class PendingOrders extends AppCompatActivity {
    ...
    private void customerPendingOrders() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("CustomerPendingOrders")
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    DatabaseReference data = FirebaseDatabase.getInstance().getReference("CustomerPendingOrders")
