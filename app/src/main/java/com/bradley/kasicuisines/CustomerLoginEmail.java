...
public class CustomerLoginEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail = (EditText) findViewById(R.id.c_edt_email);
        mPassword = (EditText) findViewById(R.id.c_edt_password);
    ...
    private void init(){
        Button signIn = findViewById(R.id.c_sign_in_email_button);
        ...
        Button signInPhone = findViewById(R.id.c_phone_link_button);
        ...
        TextView register = findViewById(R.id.c_sign_up_link);
        ...
        TextView resetPassword = findViewById(R.id.c_forgot_password);
        ...
        TextView resendEmailVerification = findViewById(R.id.c_resend_verification_email);
    ...
    public boolean servicesOK(){
        ...
        int isAvailable = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(CustomerLoginEmail.this);
        ...
        if(isAvailable == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(CustomerLoginEmail.this, isAvailable, ERROR_DIALOG_REQUEST);
            dialog.show();
        }
        else{
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if(user.isEmailVerified()){
                        ...
                        Intent intent = new Intent(getApplicationContext(), CustomerPanel_BottomNavigation.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();

                    }else{
                        Toast.makeText(CustomerLoginEmail.this, "Email is not Verified\nCheck your Inbox", Toast.LENGTH_LONG).show();
